...
#creat a empty list to store the threads
threads :list =[]
#interating though list2 to get the create the threads
for i in list2:
    #create the threads
    t=threading.Thread(target=getComic,kwargs={"comicNumber":i},daemon=False)
    #add the thread to a lists of threads
    threads.append(t)
    #start the tasks
    t.start()
